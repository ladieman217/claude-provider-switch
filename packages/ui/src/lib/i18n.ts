...
export const translations = {
  'zh-CN': {
    ...
    'form.description': '描述',
    'form.customEnv': '自定义环境变量',
    'form.customEnvOptional': '可选',
    'form.customEnvAdd': '添加变量',
    'form.customEnvRemove': '删除变量',
    'form.customEnvKey': '变量名',
    'form.customEnvValue': '变量值',
    'form.customEnvEmpty': '暂无自定义环境变量',
    'form.customEnvKeyRequired': '环境变量名不能为空',
    'form.customEnvKeyInvalid': '变量名必须以字母或下划线开头，且只能包含字母、数字和下划线',
    'form.customEnvKeyDuplicate': '环境变量名不能重复',
    'form.save': '保存',
    'form.add': '新增',
    'form.reset': '重置',
    'form.clear': '清空',
  ...
  'en': {
    ...
    'form.customEnv': 'Custom Environment Variables',
    'form.customEnvOptional': 'Optional',
    'form.customEnvAdd': 'Add Variable',
    'form.customEnvRemove': 'Remove variable',
    'form.customEnvKey': 'Variable name',
    'form.customEnvValue': 'Variable value',
    'form.customEnvEmpty': 'No custom environment variables',
    'form.customEnvKeyRequired': 'Environment variable name is required',
    'form.customEnvKeyInvalid': 'Variable names must start with a letter or underscore and contain only letters, numbers, and underscores',
    'form.customEnvKeyDuplicate': 'Environment variable names cannot be duplicated',
    'form.save': 'Save',
    'form.add': 'Add',
    'form.reset': 'Reset',
    'form.clear': 'Clear',
